...
const OrderPaymentModal = ({
  ...
  const printContent = `<body style="padding:10px 20px 20px 10px; width: 90%; margin:30px auto auto auto; border:0.8px solid #101e46;border-radius: 8px; font-family:'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;">
  <section>
  <!-- top heading -->
